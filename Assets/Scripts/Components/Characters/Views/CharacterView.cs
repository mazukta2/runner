...
namespace Assets.Scripts.Characters.Components.Views
{
    public class CharacterView : MonoBehaviour
    {
        ...
        protected void Update()
        {
            ...
            transform.position = _character.Body.Position;
            _animator.SetBool(_runningKey, Mathf.Abs(_character.Body.Force.x) > 0);
            _animator.SetBool(_groundedKey, _character.Body.IsGrounded);
        }
    }
}